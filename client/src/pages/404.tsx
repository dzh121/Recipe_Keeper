            ...
            >
              ...
              >
                <path
                  ...
                  fill={useColorModeValue("#E2E8F0", "#2D3748")}
                />
                <path
                  ...
                  fill={useColorModeValue("#4FD1C5", "#319795")}
                />
                <path
                ...
                <text
                  ...
                  fill={useColorModeValue("#2D3748", "#CBD5E0")}
                  fontWeight="bold"
                  fontSize="120"
                >
                  404
                ...
                <circle
                  ...
                  cy="120"
                  r="70"
                  fill={useColorModeValue("#FED7D7", "#63171B")}
                  fillOpacity="0.6"
                />
                <path
                  d="M245 100L205 140M205 100L245 140"
                  stroke={useColorModeValue("#E53E3E", "#FC8181")}
                  strokeWidth="10"
                  strokeLinecap="round"
                />
              </svg>
